...
//
// Optional parameters:
//  ts time - The snapshot time at which to get the document.
//            See TS() function.
//
// Returns:
//  Object - The object requested.
//
// See: https://docs.fauna.com/fauna/current/api/fql/functions/get?lang=go
...
//
// See: https://docs.fauna.com/fauna/current/api/fql/functions/keyfromsecret?lang=go
...
// Exists returns boolean true if the provided ref exists (in the case
// of an document), or is non-empty (in the case of a set), and false
// otherwise.
// Optional parameters: TS.
//
// Parameters:
//  ref Ref - The reference to the object. It could be a document
//            reference of a object reference like a collection.
//
// Optional parameters:
//  ts time - The snapshot time at which to check for the document's
//            existence. See TS() function.
//
// Returns:
//  bool - True if the reference exists, false otherwise.
//
// See: https://docs.fauna.com/fauna/current/api/fql/functions/exists?lang=go
...
//
// Parameters:
//  set SetRef - A set reference to paginate over. See Match() or
//               MatchTerm() functions.
//
// Optional parameters:
//  after Cursor  - Return the next page of results after this cursor
//                  (inclusive). See After() function.
//  before Cursor - Return the previous page of results before this
//                  cursor (exclusive). See Before() function.
//  sources bool  - If true, include the source sets along with each
//                  element. See Sources() function.
//  ts time       - The snapshot time at which to get the document.
//                  See TS() function.
//
// Returns:
...
//
// See: https://docs.fauna.com/fauna/current/api/fql/functions/paginate?lang=go
